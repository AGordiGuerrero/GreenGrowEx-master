...
/*
GreenGrowEx.cpp - Library for sensorized plantation made in Extremadura
Created by A.Gordillo-Guerrero, May, 2023.
...
//Plantation::Plantation(int VbatPin)
Plantation::Plantation(int DHTPin, int buttonPin, int relayPin, int oneWirePin):
...
void Plantation::getStatus()
{

	Serial.println();
	Serial.println("  Plantation's physical variable:");
...
void Plantation::readandcheckAll()
{
    readDHT();
    checkH();
    checkT();
...
void Plantation::readOneWire_onesensor()
{
...
// Reading via ADS1115
void Plantation::readWeight_I2C_onesample()
{
...
// Reading via ADS1115
void Plantation::readWeight_I2C_Nsamples(int Nsamples)
{
...
void Plantation::analogbuttonpressed() {
