/*
 GreenGrowEx.h - Headers for library for sensorized plantation made in Extremadura
...
#ifndef GreenGrowEx_h
#define GreenGrowEx_h
...
class Plantation
{
 ...
 public:
   ...
   Plantation(int DHTPin, int buttonPin, int relayPin, int oneWirePin);
   ...
   int T_UpperThresh=55; // Threshold for upper temperature
   int T_LowerThresh=2; // Threshold for lower temperature
   int H_UpperThresh=105; // Threshold for upper humidity
   int H_LowerThresh=3; // Threshold for lower humidity
   int WeightUpperThresh=250; // Threshold for upper weight
   int WeightLowerThresh=1; // Threshold for lower weight
